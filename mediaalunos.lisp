...
(format t "Media Alunos~%~%")
    ...
    (defun calcProjetos(proje1 proje2 proje3 proje4 artigo projeIntegrador prova)
        "Projetos(4-30%),Artigo(30%),Integrador(10%), Prova(30%)."
            (+
    ...
    (defun calcMedia(notaN1 notaN2 notaN3) 
        "N1(50%)|N2(30%)|N3(20%)"
            (+
                (* notaN1 0.5)
                (* notaN2 0.3)
